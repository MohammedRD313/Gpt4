...
def start(message):
    if message.from_user.id in banned_users:
        ...
        bot.send_message(message.chat.id,'<b>✎┊‌ اهلا بك في بوت الذكاء الاصطناعي الخاص بسورس العقرب يمكنك طرح أي سؤال أو خدمة وسيتم الإجابة عنها إن شاء الله <b>😁\n\n<b>تم الصنيع بواسطة :<b> \n<b>المطور<b>[𝗠𝗼𝗵𝗮𝗺𝗲𝗱](t.me/Zo_r0 ) \n<b>المطور<b>[𝗔𝗹𝗹𝗼𝘂𝘀𝗵](t.me/I_e_e_l ) ', parse_mode='Markdown', parse_mode='HTML', disable_web_page_preview=True)
