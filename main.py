...
def start(message):
    if message.from_user.id in banned_users:
        ...
        bot.send_message(message.chat.id,'<b>✎┊‌ اهلا بك في بوت الذكاء الاصطناعي الخاص بسورس العقرب 😁 |      يمكنك طرح أي سؤال أو خدمة وسيتم الإجابة عنها إن شاء الله           تم الصنع بواسطة : ✍🏻                     @Zo_r0 | @I_e_e_l</b>', parse_mode='HTML')
