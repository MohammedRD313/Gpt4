...
def start(message):
    if message.from_user.id in banned_users:
        ...
        bot.send_message(message.chat.id,'**✎┊‌ اهلا بك في بوت الذكاء الاصطناعي الخاص بسورس العقرب 😁  \n يمكنك طرح أي سؤال أو خدمة وسيتم الإجابة عنها إن شاء الله **', parse_mode='Markdown')
